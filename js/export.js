...
const ExportTool = (() => {
  ...
  function anleitung(basis) {
    return [
      ...
      "hat einen Typ (z. B. Rätsel, Codewort, Feuerwehrwissen), eine Stationseinleitung",
      "sowie typ-spezifische Felder wie Rätseltext, Frage oder Codewort. Die eigentliche",
      "Lösungsprüfung läuft über diese Typ-Felder – die Stationseinleitung wird nur",
      "angezeigt und nicht geprüft.",
      "",
      "Im Tab \"Karte\" werden die Marker für jede Station auf der Karte gesetzt.",
      "Ohne gesetzten Marker kann keine Station exportiert werden.",
      "",
